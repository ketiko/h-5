...
class AccountTransactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_transaction" do
    assert_difference('AccountTransaction.count') do
      post account_transactions_url, params: { account_transaction: { bank_account_id: @account_transaction.bank_account_id } }
    end
  ...
  test "should update account_transaction" do
    patch account_transaction_url(@account_transaction), params: { account_transaction: { bank_account_id: @account_transaction.bank_account_id } }
